...
public class VentanaPrincipal {
    ...
    JMenu menu1;
    JMenu menu2;
    JMenuItem micalc,micalc1,mi2,miicons,misalir,mipaint;
    ...
    public void iniciarComponentes(){
        ...
        menu1.add(micalc);
        micalc1=new JMenuItem("Calculo de iva");
        micalc1.addActionListener(new OyenteVentanaPrincipal());
        menu1.add(micalc1);
